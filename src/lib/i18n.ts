...
export const translations: Record<SupportedLocale, TranslationRecord> = {
  en: {
    ...
    subscriptionsAssign: {
      ...
      rulesHeading: "Plan Rules",
      rulesSubheading: "Set backup/pause limits for this plan",
      allowBackupLabel: "Allow Backup Days",
      allowBackupHint: "Missed days can be claimed later",
      maxBackupLabel: "Max Backup Days",
      allowPauseLabel: "Allow Subscription Pause",
      allowPauseHint: "Customers can temporarily freeze",
      maxPauseLabel: "Max Pause Days",
      backupRuleLabel: "Backup days",
      pauseRuleLabel: "Pause days",
      ruleAllowed: "Up to {count} days",
    ...
    settings: {
      ...
      store: {
        ...
        desc: "Basic information about your meal store",
        name: "Store Name",
      ...
      subscriptions: {
        ...
        desc: "Configure how subscriptions and backup days work",
        movedTitle: "Per-plan rules moved to subscription creation.",
        movedDesc: "Set backup/pause allowances while creating each plan so every plan can have its own limits.",
        goToPlans: "Go to Subscriptions",
        backupGrace: "Backup Days Grace Period",
        backupGraceHint: "Days after subscription ends to use backup days",
        editWindow: "Staff Edit Window (Days)",
        editWindowHint: "How far back staff can edit attendance",
        partialPickup: "Partial Pickup Allowed",
        partialPickupDesc: "Customer can take fewer meals than allowed",
        save: "Save Rules",
      },
      notifications: {
        title: "Notification Settings",
        desc: "Configure automated reminders and alerts",
        expiryFirst: "Expiry Reminder - First",
        expirySecond: "Expiry Reminder - Second",
        expiryHint: "Days before subscription ends",
        inactive: "Inactivity Reminder",
        inactiveHint: "Days without pickup to trigger reminder",
        save: "Save Settings",
      },
      whatsapp: {
        title: "WhatsApp Integration",
        desc: "Configure WhatsApp Business API connection",
        warningTitle: "WhatsApp Business API requires setup",
        warningDesc: "Connect your WhatsApp Business account to enable messaging",
        phone: "WhatsApp Business Phone",
        token: "API Access Token",
        tokenPlaceholder: "Enter your API token",
        messageSettings: "Message Settings",
        includeArabic: "Include Arabic Text",
        includeArabicDesc: "Send bilingual messages",
        autoSend: "Daily Menu Auto-Send",
        autoSendDesc: "Automatically send menu at scheduled time",
        save: "Save Configuration",
      },
      team: {
        title: "Team Members",
        desc: "Manage staff access and permissions",
        name: "Name",
        email: "Email",
        phone: "Phone",
  ...
  ar: {
    ...
    subscriptionsAssign: {
      ...
      rulesHeading: "قواعد الخطة",
      rulesSubheading: "حدد حدود الإيقاف/الأيام الاحتياطية لهذه الخطة",
      allowBackupLabel: "السماح بالأيام الاحتياطية",
      allowBackupHint: "يمكن المطالبة بالأيام الفائتة لاحقاً",
      maxBackupLabel: "الحد الأقصى للأيام الاحتياطية",
      allowPauseLabel: "السماح بإيقاف الاشتراك مؤقتاً",
      allowPauseHint: "يمكن للعملاء تجميد الاشتراك مؤقتاً",
      maxPauseLabel: "الحد الأقصى لأيام الإيقاف",
      backupRuleLabel: "الأيام الاحتياطية",
      pauseRuleLabel: "أيام الإيقاف",
      ruleAllowed: "حتى {count} يوم",
    ...
    settings: {
      title: "الإعدادات",
      subtitle: "اضبط بيانات المتجر والتفضيلات",
      tabs: {
        store: "المتجر",
      ...
      store: {
        title: "بيانات المتجر",
        desc: "معلومات أساسية عن متجر الوجبات",
        name: "اسم المتجر",
        nameAr: "اسم المتجر (عربي)",
        phone: "رقم التواصل",
      ...
      subscriptions: {
        ...
        desc: "اضبط كيفية عمل الاشتراكات والأيام الاحتياطية",
        movedTitle: "تم نقل القواعد إلى إنشاء الخطط.",
        movedDesc: "حدد حدود الإيقاف والأيام الاحتياطية أثناء إنشاء كل خطة بحيث يكون لكل خطة حدودها الخاصة.",
        goToPlans: "الانتقال إلى الاشتراكات",
        backupGrace: "فترة السماح للأيام الاحتياطية",
        backupGraceHint: "أيام بعد انتهاء الاشتراك لاستخدام الأيام الاحتياطية",
        editWindow: "نافذة تعديل الموظفين (أيام)",
        editWindowHint: "إلى أي مدى يمكن للموظفين تعديل الحضور",
        partialPickup: "السماح باستلام جزئي",
        partialPickupDesc: "يمكن للعميل أخذ وجبات أقل من المسموح",
        save: "حفظ القواعد",
      },
      notifications: {
        title: "إعدادات الإشعارات",
        desc: "اضبط التذكيرات والتنبيهات التلقائية",
        expiryFirst: "تذكير الانتهاء - الأول",
        expirySecond: "تذكير الانتهاء - الثاني",
        expiryHint: "أيام قبل انتهاء الاشتراك",
        inactive: "تذكير عدم النشاط",
        inactiveHint: "أيام بدون استلام لتشغيل التذكير",
        save: "حفظ الإعدادات",
      },
      whatsapp: {
        title: "تكامل واتساب",
        desc: "إعداد الاتصال بواجهة واتساب للأعمال",
        warningTitle: "يتطلب إعداد واجهة واتساب للأعمال",
        warningDesc: "صل حساب واتساب للأعمال لتمكين المراسلة",
        phone: "رقم واتساب للأعمال",
        token: "رمز الوصول API",
        tokenPlaceholder: "أدخل رمز الـ API",
        messageSettings: "إعدادات الرسائل",
        includeArabic: "تضمين النص العربي",
        includeArabicDesc: "إرسال رسائل ثنائية اللغة",
        autoSend: "إرسال تلقائي لقائمة اليوم",
        autoSendDesc: "إرسال القائمة تلقائياً في الوقت المجدول",
        save: "حفظ الإعداد",
      },
      team: {
        title: "أعضاء الفريق",
        desc: "إدارة صلاحيات الفريق",
        name: "الاسم",
        email: "البريد الإلكتروني",
        phone: "رقم الهاتف",
        role: { staff: "موظف", admin: "مدير" },
        add: "إضافة عضو",
        creating: "جاري الإضافة...",
        loading: "جارٍ تحميل الفريق...",
        empty: "لا يوجد أعضاء فريق بعد.",
        required: "الاسم ورقم الهاتف مطلوبان",
        createError: "فشل إنشاء عضو الفريق",
        created: "تم إنشاء عضو الفريق",
        updateError: "فشل تحديث عضو الفريق",
        updated: "تم تحديث عضو الفريق",
        delete: "حذف",
        deleteError: "فشل حذف عضو الفريق",
